      ...
      <a-layout-content :style="{ padding: '24px', margin: 0, minHeight: '280px' }">
        <div class="content">
          <a-spin :spinning="spinning">
            <h1>Register &nbsp; <span style="font-size: 60%;">Already a member? <router-link to="/login">Login ></router-link></span></h1>

            <div class="stepShow">
              <a-steps direction="vertical" size="small" :current="current">
                <a-step v-for="item in steps" :key="item" :title="item.name">
              ...
              <div v-if="current === 0">
                ...
                >
                  <a-input type="password" placeholder="Your password again" v-model="confirmPassword" ref="confirmPasswordInput">
                    <a-icon slot="prefix" type="lock" />
                    <a-icon v-if="confirmPassword" slot="suffix" type="close-circle" @click="emitEmptyField" />
                  </a-input>
                </a-form-item>
