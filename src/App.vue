    ...
    <a-layout-header class="header">
      ...
      >
        ...
        <a-sub-menu>
          ...
          <a-sub-menu key="program:forums" title="UV Forums" :style="{ marginRight: '1em' }">
            ...
            <a-menu-item key="program:forums:student-forum">
              <router-link to="/student-forum">Student Forum</router-link>
            </a-menu-item>
          ...
          <a-menu-item key="program:schedule">
            <router-link to="/pages/schedule">Program Details</router-link>
          </a-menu-item>
          <a-menu-item key="program:accepted-papers">
          <router-link to="/accepted-papers">Accepted Papers</router-link>
          </a-menu-item>
        </a-sub-menu>
        ...
        <a-sub-menu>
          ...
          <a-menu-item key="attending:miscellaneous-fees">
            <router-link to="/miscellaneous-fees">Miscellaneous Fees</router-link>
          </a-menu-item>
